...
<body class="hold-transition skin-blue sidebar-mini">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active">
              ...
              <ul class="treeview-menu">
                <li class="active"><a href="add_appointment.php"><i class="fa fa-calendar-plus-o"></i> Add Appointment</a></li>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="box box-primary">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form role="form" method="POST" action="" id="admin_appointment">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <select name="visit_type" class="form-control" style="width:60%">
                        <option value="">--</option>
                    ...
                    <div class="form-group">
                      ...
                      <select name="approval" class="form-control" style="width:60%">
                        <option value="">--</option>                        
                    ...
                    <div class="form-group">
                      <label>Status</label>
                      <select name="status" class="form-control" style="width:60%">
                        <option value="">--</option>
  ...
  $('#admin_appointment').on('submit',function(event){      
    event.preventDefault();
    $.ajax({
      url:"admin_appointment.php",
      method:"POST",
      data:$('#admin_appointment').serialize(),
      ...
      { 
        ...
        if(data == 0){
          $.notify({
                ...
                message: ' Appointment could not be added. Check your queries' 
              },{
                    // settings
                    type: 'danger',
                    z_index: 6000,
