...
$sql = "SELECT * FROM visit JOIN checkup ON visit.visit_id=checkup.checkup_id 
...
<head>
  ...
  <title>View Checkup Records</title>
...
<body class="hold-transition skin-blue sidebar-mini">
  <div class="wrapper">
    ...
    <header class="main-header">
                ...
                <li class="user-header">
                  ...
                  <p>
                    ...
                    <small>Administrator since <?php 
                      ...
                      echo date('F d, Y', strtotime($date));?></small>
                    </p>
                  </li>
                  <!-- Menu Footer-->
              ...
              <ul class="treeview-menu">
                <li class="active">
                  ...
                  <ul class="treeview-menu">
                    ...
                    <li class="active"><a href="checkup_records.php"><i class="fa fa-book"></i> View Records</a></li>
                  </ul>   
                </li>
              <!--Treatments-->
                <li>
            ...
            <div class="col-xs-12">           
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">List of Recorded Checkups</h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                      ...
                      if($result->num_rows > 0){
                        while($row = $result->fetch_array()){
                          ...
                          <tr>
                           ...
                           <td>
                             <center>
                               <button type='button' class='btn btn-primary view-checkup' data-toggle='modal' data-target='#viewCheckup' id='".$row['checkup_id']."'><i class='fa fa-stethoscope'></i> View Details</button>
                             </center>
                          </td>
                          ...
                          <td>
                           ...
                           <td>
                             <center>
                               <a href='edit_checkup.php?checkup_id=".$row['checkup_id']."'><button type='button' class='btn btn-info edit_checkup'><i class='fa fa-pencil-square-o'></i> Edit</button></a>
                               <button type='button' class='btn btn-danger delete' id='".$row['checkup_id']."'><i class='fa fa-trash-o'></i> Delete</button>
                             </center>  
                           </td>
      ...
      <div class='modal fade' id='deleteCheckup' tabindex='-1' role='dialog'>
       <div style='background-color: white' class='modal-dialog modal-md'> 
        <div class='modal-editPhysician'>
          <div class='modal-header'>
           <button type='button' class='close' data-dismiss='modal' aria-hidden='true'>&times;</button>
           <h4 class='modal-title' id='myModalLabel'>Delete Checkup</h4>
         </div>

         <div class='modal-body'>
          <div class='pad' id='infopanel'></div>                                
          <div class='form-horizontal' style="margin-top: -20px">
            <h5> Are you sure you want to delete this checkup? </h5>
          </div>                  
        </div>
      ...
      <!--View Checkup Details - Modal-->
      <div class="modal fade" id="viewCheckup" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-md">
          <div class="modal-viewCheckup">
  ...
  $(document).ready(function(){
    if(sessionStorage.getItem('insertKey') == 1){
      $.notify({
              ...
              message: ' Checkup has been successfully added to the database.' 
            },{
              // settings
              type: 'success'
            });
    ...
    if(sessionStorage.getItem('updateKey') == 1){
      $.notify({
              // options
              icon: 'glyphicon glyphicon-ok',
              message: ' Checkup has been successfully updated.' 
            },{
              // settings
              type: 'success'
            });
    ...
    if(sessionStorage.getItem('deleteKey') == 1){
      $.notify({
              // options
              icon: 'glyphicon glyphicon-ok',
              message: ' Checkup has been successfully deleted.' 
            },{
              // settings
              type: 'success'
            });
    ...
    $(document).on('click', '.delete', function(){      
        $('#deleteCheckup').modal('show');
        var checkup_id = $(this).attr("id");
...
<script type="text/javascript">
  ...
  $('.view-checkup').click(function(){
    var checkup_id = $(this).attr('id');
    $.ajax({url:"view_checkup_modal.php?checkup_id="+checkup_id,cache:false,success:function(result){
      $(".modal-viewCheckup").html(result);
    }});
  });
