...
if(!empty($_POST)){
	...
	if($emailDuplicate == 0){
		$sql = "UPDATE userdata SET email='$email', password='$password', firstname='$firstname', lastname='$lastname', gender='$gender', birthdate='$birthdate', address='$address', contact='$contact' WHERE user_id=".$user_id;
