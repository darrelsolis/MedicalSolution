...
<head>
  ...
  <title>View Treatment History</title>
          ...
          <ul class="treeview-menu">
            ...
            <li class="active">
              ...
              <li><a href="phy_add_treatment.php"><i class="fa fa-plus"></i> Add Treatment</a></li>
                <li class="active"><a href="phy_treatment_records.php"><i class="fa fa-history"></i> View Records</a></li>
              </ul>
            </li>
          </ul>
        </li>
                      ...
                      if($result->num_rows > 0){
                        while($row = $result->fetch_array()){
                          ...
                          <td>
                           ...
                           <td>
                             <center>
                               <a href='phy_edit_treatment.php?treatment_id=".$row['treatment_id']."'><button type='button' class='btn btn-info edit_checkup'><i class='fa fa-pencil-square-o'></i> Edit</button></a>                               
                             </center>  
                           </td>
  ...
  $(document).ready(function(){
    if(sessionStorage.getItem('insertKey') == 1){
      $.notify({
              ...
              message: ' Treatment has been successfully added.' 
            },{
              // settings
              type: 'success'
            });
