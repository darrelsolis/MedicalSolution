...
$sql = "SELECT * FROM appointment JOIN userdata phy ON appointment.physician_id=phy.user_id JOIN userdata pat ON appointment.patient_id = pat.user_id WHERE physician_id=".$physician_id." AND approval='Approved'";
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="phy_appointment_records.php"><i class="fa fa-eye"></i> View Appointments</a></li>
          </ul>
        </li>
            ...
            <div class="col-xs-12">           
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">List of Approved Appointments</h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
...
<script>
  ...
  $(document).ready(function(){
    ...
    if(sessionStorage.getItem('approvalKey') == 1){
      $.notify({
              // options
              icon: 'glyphicon glyphicon-ok',
