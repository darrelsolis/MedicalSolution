<?php 
  ...
  $sql = "SELECT * FROM treatment JOIN visit ON visit.visit_id = treatment.treatment_id JOIN prescription ON treatment.treatment_id = prescription.visit_id WHERE treatment_id=".$treatment_id;
    ...
    <section class="content">
      <div class="row">
        ...
        <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="POST" id="admin_treatment">
              <div class="box-body">
                    <input required type="hidden" class="form-control" name="physician_id" id="physician_id" value="<?php echo $row['physician_id']; ?>">
                ...
                <div class="form-group">
                  ...
                  <textarea required class="form-control" data-autoresize style="box-sizing: border-box; width:60%; resize:none" name="diagnosis"><?php echo $row['diagnosis']; ?></textarea>
                </div>

                <div class="form-group">
                  <label>Treatment</label>
                  <textarea required class="form-control" data-autoresize style="box-sizing: border-box; width:60%; resize:none" name="treatment"><?php echo $row['treatment']; ?></textarea>
                </div>
...
<script>
  ...
  $('#admin_treatment').on('submit',function(event){      
      ...
      $.ajax({
          url:"admin_treatment_update.php",
          method:"POST",
          ...
          { 
            ...
            if(data == 0){
              $.notify({
                ...
                message: ' Treatment could not be updated. Check your queries' 
              },{
                    // settings
                    type: 'danger',
                    z_index: 6000,
