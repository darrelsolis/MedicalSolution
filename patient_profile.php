...
$sql = "SELECT * FROM userdata JOIN patient ON userdata.user_id=patient.patient_id WHERE user_id=".$_SESSION['user_id'];
              ...
              <div class="box">
                ...
                <div class="box-body">
                    ...
                    <thead>
                      ...
                      <tr>
                        <th colspan="2"><h4 style="font-weight:bold">Current Health Information</h4></th>                                               
                      </tr>
                      ...
                      <tr>
                        ...
                        if($data['bloodPressure'] == ""){
                          echo "<p style='font-style:italic'>Not yet checked</p>";
                        }else{
                          echo $data['bloodPressure']; 
                        }
                        ?> </td>                        
                      </tr>
            ...
            <div class="form-horizontal">
              <form method="POST" action="" id="updateProfile">
                ...
                <div class="form-group"> 
                  ...
                  <div class="col-sm-9">
                    <textarea data-autoresize style="box-sizing: border-box; resize: none;" class="form-control" name="address" id="address" required></textarea>
  ...
  $(document).on('click', '.edit_profile', function(){  
    ...
    $('#updateProfile').on('submit',function(event){      
      ...
      $.ajax({
        ...
        { 
          if(data == 1){
            sessionStorage.setItem('pat_profile', 1);
    ...
    if(sessionStorage.getItem('pat_profile') == 1){
      $.notify({
              // options
