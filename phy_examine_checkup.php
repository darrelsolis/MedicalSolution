...
<body class="hold-transition skin-blue sidebar-mini">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li class="active">
              ...
              <ul class="treeview-menu">
                <li class="active"><a href="phy_add_checkup.php"><i class="fa fa-plus"></i> Add Checkup</a></li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li>Checkups</li>
            <li class="active">Add Checkup</li>
          </ol>
        </section>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="box box-primary">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form role="form" method="POST" action="" id="physician_checkup">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <input required type="text" class="form-control" style="width:60%" name="complain">
                    </div>

                    <div class="form-group">
                      <label>Weight</label>
                      <input required type="number" class="form-control" style="width:60%" name="weight" placeholder="In kilograms">
                    </div>

                    <div class="form-group">
                      <label>Height</label>
                      <input required type="number" class="form-control" style="width:60%" name="height" placeholder="In centimeters">
                    </div>

                    <div class="form-group">
                      <label>Blood Pressure</label>
                      <input required type="text" class="form-control" style="width:60%" name="bloodPressure">
                    </div>

                    <div class="form-group">
                      <label>Allergies</label>
                      <input required type="text" class="form-control" style="width:60%" name="allergies">
                    </div>                

                    <div class="form-group">
                      <label>Feedback</label>
                      <textarea required class="form-control" data-autoresize style="box-sizing: border-box; width:60%; resize:none" name="feedback"></textarea>
                    </div>
  ...
  $('#physician_checkup').on('submit',function(event){      
    event.preventDefault();
    $.ajax({
      url:"phy_appointment_checkup.php",
      method:"POST",
      data:$('#physician_checkup').serialize(),
      ...
      { 
        ...
        if(data == 0){
          $.notify({
                ...
                message: ' Checkup could not be added. Check your queries' 
              },{
                    // settings
                    type: 'danger',
                    z_index: 6000,
