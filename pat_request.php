...
<body class="hold-transition skin-blue sidebar-mini">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="active">
            ...
            <ul class="treeview-menu">
              <li class="active"><a href="pat_request.php"><i class="fa fa-pencil-square-o"></i> Request Appointment</a></li>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="box box-primary">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form role="form" method="POST" action="" id="request_appointment">
                  <div class="box-body">
  ...
  $('#request_appointment').on('submit',function(event){      
    event.preventDefault();
    $.ajax({
      url:"pat_appointment_process.php",
      method:"POST",
      data:$('#request_appointment').serialize(),
      ...
      { 
        ...
        if(data == 0){
          $.notify({
                ...
                message: ' Appointment could not be requested.' 
              },{
                    // settings
                    type: 'danger',
                    z_index: 6000,
