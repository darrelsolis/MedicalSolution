...
if(!empty($_POST)){
	...
	$sql_update = "UPDATE appointment SET physician_id='$physician_id', patient_id='$patient_id', visit_type='$visit_type', date='$date', time='$time', approval='$approval', status='$status' 
