...
$sql = "SELECT * FROM userdata JOIN physician ON physician.physician_id=userdata.user_id";
...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <header class="main-header">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview active">
              ...
              <ul class="active treeview-menu">
                <li class="active"><a href="manage_physicians.php"><i class="fa fa-user-md active"></i> Physicians</a></li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="col-xs-12">           
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Physician's Masterlist</h3>
                </div>
                <div class="box-body">
                  <button type="button" class="btn btn-primary" id="btnadd" name="btnadd" data-toggle="modal" data-target="#newPhysician"><i class="fa fa-plus"></i> Add Physician</button>                
                      ...
                      if($result->num_rows > 0){
                        while($row = $result->fetch_assoc()){
                          ...
                          <tr>
                           ...
                           <td><a href='#' class='physician-view' data-toggle='modal' data-target='#viewPhysician' data-id='".$row['user_id']."'>".$row['firstname']." ".$row['lastname']."</a></td>
                           <td>".$row['department']."</td>
                           <td>
                             <center>
                               <button type='button' class='btn btn-info edit_physician' id='".$row['user_id']."'><i class='fa fa-pencil-square-o'></i> Edit</button>
         ...
         <!--MODALS-->
         <div class="modal fade" id="newPhysician" tabindex="-1" role="dialog">
          <div class="modal-dialog modal-md">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" onclick="">×</button>
                <h4 class="modal-title">Manage Physician</h4>
              </div>
              <!--modal header-->
              <div class="modal-body">
                <div class="pad" id="infopanel"></div>
                <div class="form-horizontal">
                  <form method="POST" action="" id="new_physician">
      ...
      <div class='modal fade' id='deletePhysician' tabindex='-1' role='dialog'>
        ...
        <div class='modal-editPhysician'>
         ...
         <div class='modal-body'>
          ...
          <div class='form-horizontal' style="margin-top: -20px">
            <h5> Are you sure you want to delete this physician? </h5>
          </div>                  
        </div>
  ...
  <div class="modal fade" id="viewPhysician" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-md">
      <div class="modal-viewPhysician">
...
<script>
  ...
  $(document).ready(function(){
    ...
    $(document).on('click', '.edit_physician', function(){
      var physician_id = $(this).attr("id");
      $.ajax({
        url:"fetch_physician.php",
        method: "POST",
    ...
    if(sessionStorage.getItem('key') == 1){
      $.notify({
              ...
              message: ' Physician has been successfully added to the database.' 
            },{
              // settings
              type: 'success'
            });
    ...
    if(sessionStorage.getItem('key') == "Delete"){
      $.notify({
              // options
              icon: 'glyphicon glyphicon-ok',
              message: ' Physician has been successfully deleted in the database.' 
            },{
              // settings
              type: 'success'
            });
    ...
    if(sessionStorage.getItem('key') == "Record Found"){
      $.notify({
              // options
              icon: 'glyphicon glyphicon-ban-circle',
              message: ' Notice: Physician has existing records in the system.' 
            },{
              // settings
              type: 'danger'
            });
...
<script type="text/javascript">
  //Script for VIEWING physician's personal details inside modal
  $('.physician-view').click(function(){
    var physician_id = $(this).attr('data-id');
    $.ajax({url:"view_physician_modal.php?physician_id="+physician_id,cache:false,success:function(result){
      $(".modal-viewPhysician").html(result);
    }});
  });
