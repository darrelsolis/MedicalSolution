...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <header class="main-header">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-calendar-plus-o"></i> Manage Appointments</a></li>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="box box-primary">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form role="form" method="POST" action="" id="admin_appointment_update">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <select required name="visit_type" id="visit_type" class="form-control" style="width:60%">
                        <option value="">--</option>
                    ...
                    <!--Make algortihm for selecting time in a loop-->
                    <div class="form-group">
                      <label>Time</label>
                    ...
                    <div class="form-group">
                      ...
                      <select required name="approval" id="approval" class="form-control" style="width:60%">
                        <option value="">--</option>                        
                    ...
                    <div class="form-group">
                      <label>Status</label>
                      <select required name="status" id="status" class="form-control" style="width:60%">
                        <option value="">--</option>
                    ...
                    <div class="form-group">
                      <input type="hidden" class="form control" style="width:60%" name="appointment_id" id="appointment_id" value="<?php echo $appointment_id; ?>">
  ...
  $(document).ready(function() { 
    ...
    $('#admin_appointment_update').on('submit',function(event){      
      event.preventDefault();
      $.ajax({
        url:"admin_appointment_update.php",
        method:"POST",
        data:$('#admin_appointment_update').serialize(),
        success: function(data)
        { 
          if(data == 1){
            sessionStorage.setItem('updateKey', 1);
            window.location = "http://localhost/MedicalSolution/appointment_records.php";  
          }
