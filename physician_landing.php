...
require('date.php');
$sql = "SELECT *, CURDATE() as currentDate FROM appointment JOIN userdata ON userdata.user_id=appointment.patient_id WHERE physician_id=".$_SESSION['user_id']." AND approval='Approved' HAVING date=currentDate";
                        ...
                        <tr>
                          ...
                          <td>";
                            if($row['status'] == 'Ongoing'){
                              if($row['visit_type'] == 'Checkup'){
                                echo "<center><a href='phy_examine_checkup.php?appointment_id=".$row['appointment_id']."'><button type='button'  class='btn btn-info' style='width:90%'><i class='fa fa-stethoscope fa-fw' aria-hidden='true'></i> Examine Patient</button></a></center>"; 
                              }else{
                                echo "<center><a href='phy_examine_treatment.php?appointment_id=".$row['appointment_id']."'><button type='button'  class='btn btn-info' style='width:90%'><i class='fa fa-stethoscope fa-fw' aria-hidden='true'></i> Examine Patient</button></a></center>"; 
                              }                              
                            }else if($row['status'] == 'Cancelled'){
                              echo "<center><button type='button' style='opacity:1.0; width:90%' class='btn btn-danger' disabled><i class='fa fa-times fa-fw' aria-hidden='true'></i> Cancelled</button></center>";
                            }else{
                              echo "<center><button type='button' style='opacity:1.0; width:90%' class='btn btn-success' disabled><i class='fa fa-check-circle fa-fw' aria-hidden='true'></i> Done</button></center>";
                            }
                            "</td>                                                        
                          </tr>
                          ";
