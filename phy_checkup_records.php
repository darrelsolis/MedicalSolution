...
<head>
  ...
  <title>View Checkup History</title>
          ...
          <ul class="treeview-menu">
            <li class="active">
              ...
              <li><a href="phy_add_checkup.php"><i class="fa fa-plus"></i> Add Checkup</a></li>
                <li class="active"><a href="phy_checkup_records.php"><i class="fa fa-history"></i> View Records</a></li>
              </ul>
            </li>
                      ...
                      if($result->num_rows > 0){
                        while($row = $result->fetch_array()){
                          ...
                          <td>
                           ...
                           <td>
                             <center>
                               <a href='phy_edit_checkup.php?checkup_id=".$row['checkup_id']."'><button type='button' class='btn btn-info edit_checkup'><i class='fa fa-pencil-square-o'></i> Edit</button></a>                              
                             </center>  
                           </td>
        ...
        <div class='modal-editPhysician'>
         ...
         <div class='modal-body'>
          ...
          <div class='form-horizontal' style="margin-top: -20px">
            <h4> Are you sure you want to delete this checkup? </h4>
          </div>                  
        </div>
  ...
  $(document).ready(function(){
    if(sessionStorage.getItem('insertKey') == 1){
      $.notify({
              ...
              message: ' Checkup has been successfully added.' 
            },{
              // settings
              type: 'success'
            });
