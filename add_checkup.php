            ...
            <li class="treeview active">          
              ...
              <ul class="treeview-menu">
                <li class="active">
                  ...
                  <ul class="treeview-menu">
                    <li class="active"><a href="add_checkup.php"><i class="fa fa-plus"></i> Add Checkup</a></li>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="box box-primary">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form role="form" method="POST" action="" id="admin_checkup">
                  <div class="box-body">
    ...
    $.ajax({
      ...
      { 
        if(data == 1){
          ...
          window.location = "http://localhost/MedicalSolution/checkup_records.php";  
        }
